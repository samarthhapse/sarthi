      ...
      <div className="w-[900px] flex rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="flex-[1.5] flex flex-col items-center justify-center bg-white p-10">
          <form onSubmit={handleSubmit} className="flex flex-col items-center w-full">
            ...
            <div className="text-gray-600 mb-4">Time left: {formatTime(timeLeft)}</div>
            <button
              type="submit"
              className="mt-2 bg-teal-500 text-white font-bold text-md py-3 px-8 rounded-full transition-all hover:bg-teal-600"
              disabled={timeLeft === 0}
            >
              Submit
            </button>
